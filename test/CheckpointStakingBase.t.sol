...
contract CheckpointStakingBaseTest is Test {
    ...
    function newStakingDepositor(uint256 _stakingTokensToFund)
        public
        returns (CheckpointStakingDepositor)
    {
    ...
    function test_Stake() public {
        ...
        StakingCheckpoint.DepositCheckpoint[] memory depositCheckpoints = stakingContract.getDepositCheckpoints(address(depositor), 1);
